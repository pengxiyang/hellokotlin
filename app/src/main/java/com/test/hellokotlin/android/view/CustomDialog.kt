...
import com.test.hellokotlin.databinding.CustomDialogLayoutBinding
    ...
    private fun buildPermissionsLayout() {
        for (permission in permissions) {
            ...
            if (permissionGroup != null && !groupSet.contains(permissionGroup)) {
                val textView = LayoutInflater.from(context).inflate(R.layout.permissions_item, binding.permissionsLayout, false) as TextView
